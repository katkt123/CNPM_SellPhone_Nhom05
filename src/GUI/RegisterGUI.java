...
public class RegisterGUI extends javax.swing.JFrame {
    private DangKyBLL dkBLL = new DangKyBLL();
    ...
    public void solveEvent(){
        this.regist.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                if(!usename.getText().isEmpty() || !new String(password.getPassword()).isEmpty() || !fullname.getText().isEmpty() || !phone.getText().isEmpty() || !direct.getText().isEmpty()){
                    dkBLL.xuLyDangKy(usename.getText(),new String(password.getPassword()), fullname.getText(), phone.getText(), direct.getText());            
                } else{
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(35, 134, 54));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(usename, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(50, 50, 50)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(direct, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(145, 145, 145)
