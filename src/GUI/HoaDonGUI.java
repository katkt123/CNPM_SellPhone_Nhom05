...
public class HoaDonGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton_ThanhToan.setBackground(new java.awt.Color(35, 134, 54));
        jButton_ThanhToan.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jButton_CapNhat.setBackground(new java.awt.Color(35, 134, 54));
        jButton_CapNhat.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        int i= jTable_HD.getSelectedRow();
         if(i>=0){
            ...
            hdBLL.DelHD(modelHD.getValueAt(i, 1).toString());
             ...
             JOptionPane.showMessageDialog(this, "Bạn chưa chọn hóa đơn để xóa ?", "Thông báo", JOptionPane.INFORMATION_MESSAGE);         
...
//        HoaDonDTO pn = new HoaDonDTO();
        ...
        if (row < 0) {
            ...
            Object valuenull1 = modelHD.getValueAt(row, 2);
            if (valuenull != null || valuenull1 != null) {
                ...
                String ma = hdDAO.getIDactive(tendangnhap, matkhau);
                
                System.out.print(ma +"---------------------");
                modelHD.setValueAt(ma,row,2);
                String manv = hdDAO.getMaNV(ma);
                modelHD.setValueAt(dateFormat.format(new Date()), row, 5);
                if(hdDAO.AddMaNV(modelHD.getValueAt(row, 1).toString(), manv)){
...
//    }
    ...
    private void loadHDlist(){
        ...
        for(int i = 0; i<arrHoaDon.size();i++){
            ...
            float tong = em.getTongTienGoc();
            float tongsaugiam= em.getTongTienSauGiam();
